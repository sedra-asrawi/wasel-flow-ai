-- Add comprehensive fake data using existing and new driver IDs

-- Add more drivers (these will get auto-incremented IDs)
...
-- Add deliveries using existing driver IDs only
INSERT INTO public.deliveries (order_id, driver_id, status, assigned_at, picked_up_at, delivered_at) VALUES 
(7, 7, 'delivered', NOW() - INTERVAL '5 hours', NOW() - INTERVAL '4 hours 30 minutes', NOW() - INTERVAL '4 hours'),
(8, 8, 'delivered', NOW() - INTERVAL '3 hours', NOW() - INTERVAL '2 hours 30 minutes', NOW() - INTERVAL '2 hours'),
(9, 2, 'delivered', NOW() - INTERVAL '1 hour', NOW() - INTERVAL '45 minutes', NOW() - INTERVAL '30 minutes'),
(10, 7, 'picked_up', NOW() - INTERVAL '45 minutes', NOW() - INTERVAL '30 minutes', NULL),
(11, 8, 'assigned', NOW() - INTERVAL '15 minutes', NULL, NULL)
